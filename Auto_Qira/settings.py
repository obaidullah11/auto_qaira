...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
# EMAIL_HOST_USER = 'warehousevisuwalls@gmail.com'
# EMAIL_HOST_PASSWORD = 'furx fxnc earg uuun'
...
CHAPA_SECRET_KEY = 'CHASECK_TEST-wxUNoHIeCYCuqXsCtCEUyaOxPrtumxrK' 
SWAGGER_SETTINGS = {
...
WSGI_APPLICATION = 'Auto_Qira.wsgi.application'

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3',
        'NAME': BASE_DIR / 'Auto_Qiradb',
    }
}
# DATABASES = {
#     'default': {
...
#         'USER': 'postgres',                     
#         'PASSWORD': 'Obaid123!',                 
#         'HOST': 'localhost',                  # Or the IP address if it's on another machine
...
JAZZMIN_SETTINGS = {
    "site_title": "Auto_Qira Admin",
    "site_header": "Auto_Qira  Admin Panel",
    "site_brand": "Auto_Qira",
    "welcome_sign": "Welcome to Auto_QiraAdmin",
    "copyright": "Auto_Qira2025",
    "topmenu_links": [
